      ...
      <div>
        <div className="flex justify-between pt-5 pb-5 pr-5 pl-5 bg-white">
          ...
          <div className="w-[25rem] h-10">
            <div className="flex border justify-between border-solid h-full border-red-500 rounded-full pt-[3px] pr-4 pl-1 pb-2">
              <input
                className="text-slate-500 outline-0 font-bold w-[80%] text-sm"
                type="text"
